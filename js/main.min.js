...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initGo: function() { return /* binding */ initGo; }
/* harmony export */ });
var initGo = function initGo() {
  var tabMenu = document.querySelector('.header__tab-menu');
  var buttonAssortment = document.querySelector('.header__button');
  ...
  function moveTabMenu() {
    var isMobileView = window.innerWidth <= 1150;
...
var initTabs = function initTabs() {
  var tabButtons = document.querySelectorAll('.header__tab-btn');
  var tabPanels = document.querySelectorAll('.header__panel-item');
  tabButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      tabButtons.forEach(function (btn) {
        return btn.classList.remove('header__tab-btn--active');
      });
  ...
  var toggleMenuButton = document.querySelector('[data-toggle-menu]');
  button.addEventListener('click', function () {
...
/* harmony import */ var _modules_init_go__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-go */ "./js/modules/init-go.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_init_tabs__WEBPACK_IMPORTED_MODULE_8__.initTabs)();
  (0,_modules_init_go__WEBPACK_IMPORTED_MODULE_9__.initGo)();
